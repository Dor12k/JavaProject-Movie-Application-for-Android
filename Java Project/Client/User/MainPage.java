...
import com.dor.cmovies.resources.UserResource;
...
public class MainPage extends AppCompatActivity {
    ...
    public static final String QUERY_FOR_SHOW = "http://localhost:8080/movies/webapi/authentication/";

    //    public static final String QUERY_FOR_SHOW = "http://192.168.1.19:8080/movies/webapi/authentication/";
    ...
    public void maRegisterBTN(View view){

        Intent userLogIn = new Intent(this, UserResource.class);
    ...
    public String validation(Authentication authentication){
        ...
        JsonObjectRequest objectRequest = new JsonObjectRequest(Request.Method.PUT, QUERY_FOR_SHOW, new JSONObject(jsonParams), new Response.Listener<JSONObject>() {
            @Override
